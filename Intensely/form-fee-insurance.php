...
<html lang="en">
  <head>
    ...
    <title>Murieta Owners Association : Form, Fees & Insurance</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="single-page-header-right">
              <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active">Form, Fees & Insurance</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
            <h2 class="title">Forms and Useful Info</h2>
            <span class="line"></span>
            <p>All forms are to be printed, filled-out, and either emailed to <a href="mailto:murietahoa@gmail.com">murietahoa@gmail.com</a>, brought to the HOA Onsite Office, or faxed to 510-683-8940.</p>
          </div>
        </div>
        <div class="col-md-12">
